                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    <?= session('nama');?> - <?= session('thn_akademik');?>
                                </p>
                            </li>
                            <!-- Menu Body -->
        ...
        <section class="sidebar">
            ...
            <div class="user-panel" style="height: 60px">
                <div class="pull-left info" style="    left: 0px !important;">
                    <p>Login As : <strong><?= session('nama');?></strong></p>
                    <a href="#"><i class="fa fa-circle text-success"></i> Tahun Akademik <?= session('thn_akademik');?></a>
                </div>
            </div>
            <!-- search form -->
